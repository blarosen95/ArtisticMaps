...
public class CustomItem {
    ...
    CustomItem(Material material, String uniqueKey) {
        this.material = material;
        this.key = uniqueKey;
    }

    CustomItem(Material material, String key, String name) {
        this.material = material;
        this.key = key;
        this.name = name;
    }
    ...
    CustomItem(ItemStack stack, String key) {
        this.stack = Optional.of(stack);
        this.material = stack.getType();
        this.key = key;
    }

    CustomItem name(String name) {
        this.name = name;
        return this;
    }
    ...
    CustomItem tooltip(String... tooltip) {
        this.tooltip = tooltip;
        return this;
    }
    ...
    CustomItem flag(ItemFlag... itemFlags) {
        this.itemFlags = itemFlags;
        return this;
    }

    CustomItem recipe(SimpleRecipe recipe) {
        this.recipe = recipe;
        return this;
    }
    ...
    public boolean checkItem(ItemStack itemStack) {
        if (itemStack != null && itemStack.getType() == material && itemStack.hasItemMeta()) {
            ...
            return itemMeta.hasLore() && itemMeta.getLore().get(0).contains(key);
        }
        return false;
    }
    ...
    public ItemStack toItemStack() {
        //Get or create stack
        ItemStack item = stack.orElseGet(() -> new ItemStack(material, amount));
        ...
        if (enchants.size() > 0) {
            for (Enchantment ench : enchants.keySet()) meta.addEnchant(ench, enchants.get(ench), true);
        }
