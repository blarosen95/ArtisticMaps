...
import com.github.blarosen95.ArtisticMaps.IO.YamlReader;
...
public class RecipeLoader {
    ...
    public RecipeLoader(ArtisticMaps plugin, Configuration configuration) {
    ...
    private HashMap<Character, Ingredient> readRecipeMaterials(String recipeName, ConfigurationSection materialList) throws InvalidRecipeException {
