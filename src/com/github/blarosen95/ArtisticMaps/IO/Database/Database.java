...
public final class Database {
    ...
    private Database(JavaPlugin plugin, SQLiteDatabase database, ArtTable artworks, MapTable maps) {
        SQLiteDatabase database1 = database;
...
//TODO: that wiki link needs to be processed into a more user friendly file/source
    ...
    public Map createMap() {
        ...
        return new Map(Objects.requireNonNull(mapView));
    }
