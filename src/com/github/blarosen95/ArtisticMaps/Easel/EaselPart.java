...
import static com.github.blarosen95.ArtisticMaps.ArtisticMaps.getBukkitVersion;
import static com.github.blarosen95.ArtisticMaps.Utils.VersionHandler.BukkitVersion.v1_8;
...
public enum EaselPart {
    STAND(ARMOR_STAND, 0.4, -1, true), FRAME(ITEM_FRAME, 1, 0, false), SIGN(ARMOR_STAND, 0, 0, false), SEAT(ARMOR_STAND,
            getBukkitVersion().getVersion().getSeatXOffset(), getBukkitVersion().getVersion().getSeatYOffset(), true),
    MARKER(ARMOR_STAND, SEAT.modifier, 0, true);

    public static final String ARBITRARY_SIGN_ID = "*{=}*";
    private static final String EASEL_ID = Lang.RECIPE_EASEL_NAME.get();
    ...
    EaselPart(EntityType entityType, double modifier, double heightOffset, boolean centered) {
