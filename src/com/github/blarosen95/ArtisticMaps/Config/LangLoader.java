...
class LangLoader {
    ...
    private final HashMap<String, String> missingStrings = new HashMap<>();
    ...
    String[] loadRegex() {
        List<String> msg = lang.getStringList("ILLEGAL_EXPRESSIONS");
        if (msg != null) return msg.toArray(new String[0]);
        return new String[0];
    }
