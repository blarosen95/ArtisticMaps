...
public class MenuHandler {
    ...
    public MenuHandler(JavaPlugin plugin) {
        MenuListener listener = new MenuListener(this, plugin);
    }
    ...
    public static class MenuList {
        public final MenuFactory HELP = new StaticMenuFactory(HelpMenu::new);
        public final MenuFactory DYES = new StaticMenuFactory(DyeMenu::new);
        public final MenuFactory TOOLS = new StaticMenuFactory(ToolMenu::new);
        public final MenuFactory ARTIST = new DynamicMenuFactory(ArtistMenu::new);
        public final MenuFactory RECIPE = new ConditionalMenuFactory(new ConditionalMenuFactory.ConditionalGenerator() {
            @Override
