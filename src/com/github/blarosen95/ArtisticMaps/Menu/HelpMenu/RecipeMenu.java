...
public class RecipeMenu extends BasicMenu implements ChildMenu {
    ...
    private final boolean version_1_12 = ArtisticMaps.getBukkitVersion().getVersion().isEqualTo(VersionHandler.BukkitVersion.v1_12);
    ...
    private class RecipeButton extends Button {
        ...
        RecipeButton(ArtMaterial material) {
