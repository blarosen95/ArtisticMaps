...
public class Heads {
    ...
    private static final Map<UUID, TextureData> textureCache = new HashMap<>();
    ...
    private static TextureData getSkinUrl(UUID uuid) {
        try {
            ...
            JsonObject o = parser.parse(Objects.requireNonNull(json)).getAsJsonObject();
    ...
    private static class TextureData {
        ...
        TextureData(String name, String texture) {
            this.name = name;
